        ...
        
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Notification notification2 = new Notification(DateTime.Now, "987654322", "Meeting", "First time meeting");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (IsPostBack)
            {
                ...
                Notification notification4 = new Notification(DateTime.Now.AddDays(-1), "987654432", "Meeting", "First time meeting");
        ...
        protected void btnNext_Click(object sender, EventArgs e)
        {
            ...
            Notification notification3 = new Notification(DateTime.Now.AddDays(1), "987654332", "Meeting", "First time meeting");
